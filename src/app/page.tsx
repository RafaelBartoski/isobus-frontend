      ...
      <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
          <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
            <div className="flex flex-wrap justify-center">
              ...
              <h1 className="text-3xl font-semibold text-left text-green-800 uppercase">
              ...
              <form className="mt-6">
                  <div className="mb-2">
                      ...
                      <input
                          type="email"
                          className="block w-full px-4 py-2 mt-2 text-green-700 bg-white border rounded-md focus:border-green-600 focus:ring-green-600 focus:outline-none focus:ring focus:ring-opacity-40"
                      />
                  </div>
                  <div className="mb-2">
                      <label
